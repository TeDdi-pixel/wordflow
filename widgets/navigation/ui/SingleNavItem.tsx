...
export const SingleNavItem = ({ item }: SingleNavItemProps) => {
  ...
  return (
    <>
      <Link
        href={item.path}
        className="flex gap-1 items-center transition-all px-[8px] py-[4px] cursor-pointer text-text group-hover:scale-25 group-hover:opacity-25 duration-300 opacity-100 scale-100 h-[33px]"
      >
