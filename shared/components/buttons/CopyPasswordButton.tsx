...
const CopyPasswordButton = ({ handleCopy, canCopy }: Props) => {
  return (
    <button
      type="button"
      onClick={handleCopy}
      className={`flex text-accent items-center justify-center cursor-pointer absolute -right-[17px] z-10 -translate-y-1/2 top-1/2 w-[36px] h-[36px] transition-all duration-150 ease-out ${
        canCopy
