...
const PracticeNavButton = ({ side = "right", onClick, isDisabled }: Props) => {
  return (
    <button
      ...
      type="button"
      onClick={onClick}
      className={`group w-[44px] h-[44px] bg-button hover:bg-background-accent flex items-center justify-center rounded-default transition-all ease-in-out duration-150 ${
