...
const TipButton = ({
  ...
  const tooltipClasses = `pointer-events-none absolute top-1/2 -translate-y-1/2 bg-background-accent-2 text-text-2 text-sm px-3 py-1 rounded-md shadow-lg opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 transition-all duration-150 whitespace-nowrap z-10 ${
