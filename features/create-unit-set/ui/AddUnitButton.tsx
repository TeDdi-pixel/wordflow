...
const AddUnitButton = ({ unitId }: { unitId: number }) => {
  ...
  return (
    ...
    >
      <TbCirclePlusFilled className="w-full h-full text-[48px] bg-background-accent-2 hover:bg-accent text-background hover:text-text-2 transition-all duration-200 ease-out" />
    </button>
  );
};
